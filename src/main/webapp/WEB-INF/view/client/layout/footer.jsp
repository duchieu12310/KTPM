                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Author:Nhom 13</p>
                            <p>Website: <a href="https://nhom13.vn" target="_blank"> nhom13.vn</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="https://nhom13.vn" target="_blank"><i
                                    class="fas fa-copyright text-light me-2"></i>Nhom 13</a>, All right
                            reserved.</span>
                    </div>
